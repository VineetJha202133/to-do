...
import 'package:todo/component/iconpicker/controller/icon_picker_controller.dart';
...
class _IconPickerState extends State<IconPicker> {
  IconPickerController iconController = IconPickerController();

  @override
  void initState() {
    iconController.setSelectedIconData(widget.currentIconData);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<IconPickerController>(
      create: (BuildContext context) => iconController,
      child: Container(
        ...
        child: GridView.builder(
          itemBuilder: (BuildContext context, int index) {
            ...
            return Material(
              ...
              child: InkWell(
                onTap: () {
                  iconController.setSelectedIconData(iconData);
                ...
                child: TodoBadge(
                  ...
                  outlineColor: iconData == iconController.selectedIconData
                      ? widget.highlightColor
                      : widget.unHighlightColor,
                  color: iconData == iconController.selectedIconData
                      ? widget.highlightColor
                      : widget.unHighlightColor,
                  size: 32,
                ),
